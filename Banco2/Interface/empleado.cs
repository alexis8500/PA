...
namespace Banco2
{
  ...
  {
    public static void employee(Models.Empleado empleado)
    {
      bool salir = false;
      do
      {
    ...
    public static void verPrestamosParaAceptar(Models.Empleado empleado)
    {
        ...
        else
        {
          ...
          switch (opcion)
          {
            ...
            case "2":
              ...
              if (rSolicitud is Models.SolicitudPrestamo)
              {
    ...
    public static void calcularPrestamos(Models.Empleado empleado)
    {
      using (var db = new Models.bancoContext())
      {
    ...
    public static void verUltimoPrestamo(Models.Empleado empleado)
    {
      using (var db = new Models.bancoContext())
      {
        ...
        {
          var presta = (Models.Prestamo)prestamo;
    ...
    public static void verUltimosPrestamos(Models.Empleado empleado)
    {
      using (var db = new Models.bancoContext())
      {
        Write("\nIngrese el id del usuario: ");
        ...
        if (prestamos is List<Models.Prestamo>)
        {
          int i = 1;
          var presta = (List<Models.Prestamo>)prestamos;
          WriteLine("\nUltimos prestamos");
    ...
    public static void verPrestamosAceptados(Models.Empleado empleado)
    {
      using (var db = new Models.bancoContext())
      {
